...
public class Subwoofer {
    ...
    public Integer getPotenciaMaximaW() { return potenciaMaximaW; }
    public void setPotenciaMaximaW(Integer potenciaMaximaW) { this.potenciaMaximaW = potenciaMaximaW; }
    ...
    public String getTipoBobina() { return tipoBobina; }
    public void setTipoBobina(String tipoBobina) { this.tipoBobina = tipoBobina; }

    public Double getSensibilidadeDb() { return sensibilidadeDb; }
    public void setSensibilidadeDb(Double sensibilidadeDb) { this.sensibilidadeDb = sensibilidadeDb; }
    ...
    public String getTipoCaixaIdeal() { return tipoCaixaIdeal; }
    public void setTipoCaixaIdeal(String tipoCaixaIdeal) { this.tipoCaixaIdeal = tipoCaixaIdeal; }

    public Double getVolumeCaixaLitros() { return volumeCaixaLitros; }
    public void setVolumeCaixaLitros(Double volumeCaixaLitros) { this.volumeCaixaLitros = volumeCaixaLitros; }
